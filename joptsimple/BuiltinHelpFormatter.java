...
public int compare(Object o1, Object o2) {
  ...
  private String createOptionDisplay(OptionDescriptor descriptor)
  {
    ...
    for (@SuppressWarnings("rawtypes")
	Iterator i = descriptor.options().iterator(); i.hasNext(); ) {
  ...
  private String createDescriptionDisplay(OptionDescriptor descriptor) {
    ...
    return (descriptor.description() + ' ' + Strings.surround(new StringBuilder().append("default: ").append(defaultValuesDisplay).toString(), '(', ')')).trim();
  }
